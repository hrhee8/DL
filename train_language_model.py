...
for epoch in range(0, 75):
    ...
    print('Train', 'epoch', epoch, 'Acc', "%.2f" % (epoch_acc * 100.0), 'loss', "%.4f" % epoch_loss, 'time',
    ...
    if ((epoch + 1) % 1 == 0):
        ...
        print("test", 'Acc', "%.2f" % (epoch_acc * 100.0), 'loss', "%.4f" % epoch_loss, 'time',
              "%.4f" % float(time.time() - time1))
