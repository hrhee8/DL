...
train_directory = '/u/eot/hyunjoonrhee/scratch/aclImdb/train/'
...
test_directory = '/u/eot/hyunjoonrhee/scratch/aclImdb/test/'
...
glove_filename = '/u/eot/hyunjoonrhee/scratch/aclImdb/glove.840B.300d.txt'
